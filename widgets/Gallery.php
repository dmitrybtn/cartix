...
use powerkernel\photoswipe\PhotoswipeAsset;
use yii\helpers\Html;

class Gallery extends \powerkernel\photoswipe\Gallery
{
    public $items = []; // Gallery images
    public $col = 'col-sm-3 col-md-3'; // Bootstrap grid system
    public $imgClass = 'img-responsive'; // the img class
...
EOD;
            ...
            foreach ($this->items as $i=>$item) {
                echo Html::beginTag('div', ['class' => $this->col]);
                    echo Html::beginTag('div', ['class' => 'thumbnail', 'itemscope'=>true, 'itemprop' => 'associatedMedia', 'itemtype' => 'http://schema.org/ImageObject']);
                        ...
                        if (!empty($item['caption'])) {
                            echo Html::beginTag('div', ['class' => 'caption', 'itemprop' => 'caption description']);
                            echo $item['caption'];
