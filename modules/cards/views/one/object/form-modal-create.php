...
?>
	...
	<?php $form = ActiveForm::begin([
		...
		'action' => $this->context->to(['/cards/one/object/ajax-create', 'id_transfer' => $modTransfer->id]),
	...
	<div class="modal-body">
		<?php echo $this->render('@app/modules/cards/views/one/object/form-inputs', ['modObject' => $modObject ?? new CardObject, 'form' => $form]) ?>
	</div>
