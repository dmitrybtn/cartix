				...
				<tr data-transfer-key='<?php echo $modTransfer->id ?>'>
					...
					<?php if ($this->context->card->isMy): ?>
						<td class='action-column action-column-5'>
							<?php echo Html::a(BHtml::icon('plus'), $this->context->to(['/card/one/object/create', 'id' => $modTransfer->id]), ['class' => 'create']) ?>
							<?php echo Html::a(BHtml::icon('pencil'), $this->context->to(['/card/one/transfer/update', 'id' => $modTransfer->id]), ['class' => 'update']) ?>
							<?php echo Html::a(BHtml::icon('arrow-up'), $this->context->to(['/card/one/transfer/sort', 'id' => $modTransfer->id]), ['class' => 'lift']) ?>
							<?php echo Html::a(BHtml::icon('arrow-down'), $this->context->to(['/card/one/transfer/sort', 'id' => $modTransfer->id, 'inv' => 1]), ['class' => 'drop']) ?>
							<?php echo Html::a(BHtml::icon('trash'), $this->context->to(['/card/one/transfer/delete', 'id' => $modTransfer->id]), ['class' => 'delete', 'data-confirm' => 'Точно?', 'data-method' => 'POST']) ?>
						</td>
					<?php endif ?>
					...
					<tr data-object-key='<?php echo $modObject->id ?>'>
						...
						<?php if ($this->context->card->isMy): ?>
							<td class='action-column action-column-5' style='text-align: right;'>
								<?php echo Html::a(BHtml::icon('pencil'), $this->context->to(['/card/one/object/update', 'id' => $modObject->id]), ['class' => 'update']) ?>
								<?php echo Html::a(BHtml::icon('arrow-up'), $this->context->to(['/card/one/object/sort', 'id' => $modObject->id])) ?>
								<?php echo Html::a(BHtml::icon('arrow-down'), $this->context->to(['/card/one/object/sort', 'id' => $modObject->id, 'inv' => 1])) ?>
								<?php echo Html::a(BHtml::icon('trash'), $this->context->to(['/card/one/object/delete', 'id' => $modObject->id]), ['class' => 'delete', 'data-confirm' => 'Точно?', 'data-method' => 'post']) ?>
							</td>
						<?php endif ?>
					...
					<?php if ($this->context->card->isMy): ?>
						...
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								<li><?php echo Html::a('Передвинуть ниже', $this->context->to(['/card/one/transfer/sort', 'id' => $modTransfer->id, 'inv' => 1])) ?></li>
								<li><?php echo Html::a('Удалить', $this->context->to(['/card/one/transfer/delete', 'id' => $modTransfer->id]), ['data-confirm' => 'Точно?', 'data-method' => 'post']) ?></li>
							</ul>						
						</div>
						...
						<?php if ($this->context->card->isMy): ?>
							...
							<div class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><?php echo Html::a('Удалить', $this->context->to(['/card/one/object/delete', 'id' => $modObject->id], ['data-confirm' => 'Точно?', 'data-method' => 'post'])) ?></li>
								</ul>						
							</div>
						<?php else: ?>
